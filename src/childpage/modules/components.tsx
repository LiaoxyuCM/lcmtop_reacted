...
export var Icons = {
  ...
  LightMode: () => (
    <svg width={21} height={20} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22">
      <path
        fill='none'
        strokeLinecap="round"
        strokeMiterlimit="10"
        strokeWidth="1.5"
        stroke="currentColor"
        d="M12 4v-2M12 20v2M4 12H2M20 12h2M6.5 6.5L5 5M17.5 17.5l1.5 1.5M6.5 17.5L5 19M17.5 6.5l1.5 -1.5M12 7.5A4.5 4.5 0 1 1 11.99 7.5"
      />
    </svg>
  ),
  DarkMode: () => (
    <svg width={20} height={20} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22">
      <path
        fill="none"
        strokeLinecap="round"
        strokeMiterlimit="10"
